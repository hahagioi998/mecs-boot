...
<head>
<meta charset="utf-8">
<link rel="stylesheet" href="<%=request.getContextPath() %>/3rd/layui/css/layui.css">
<script src="<%=request.getContextPath() %>/3rd/layui/layui.js"></script>
<link rel="stylesheet" href="<%=request.getContextPath() %>/css/new_file.css" />
<link rel="stylesheet" href="<%=request.getContextPath() %>/3rd/res/static/css/index.css">
</head>
